...
const unreadCountHandler = http.get("*/notifications/unread-count", () =>
  HttpResponse.json({ count: 0 }),
);

const executeSuccessHandler = http.post("*/playground/execute", () =>
  HttpResponse.json({
    stdout: "Hello, World!\nCurrent time: " + now,
    stderr: "",
    exitCode: 0,
...
const executeErrorHandler = http.post("*/playground/execute", () =>
  HttpResponse.json({
    stdout: "",
    stderr:
...
const executePendingHandler = http.post("*/playground/execute", async () => {
