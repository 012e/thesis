...
const meta = {
    ...
    tags: ["autodocs"],
    decorators: [
        (Story) => (<div className="h-[700px] w-[700px] border rounded-lg bg-background text-foreground mx-auto my-8">
        <Story />
      </div>),
    ],
};
