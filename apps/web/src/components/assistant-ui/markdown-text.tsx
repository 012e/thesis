...
const MarkdownTextImpl = () => {
  return (
    <MarkdownTextPrimitive
      ...
      className="flex justify-center items-center aui-md"
...
const CodeHeader: FC<CodeHeaderProps> = ({ language, code }) => {
  ...
  return (
    <div className="flex justify-between items-center py-1.5 px-3 mt-2.5 text-xs rounded-t-lg border border-b-0 aui-code-header-root border-border/50 bg-muted/50">
      <span className="font-medium lowercase aui-code-header-language text-muted-foreground">
        {language}
      </span>
