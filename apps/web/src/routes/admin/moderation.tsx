...
const validationStatusClasses: Record<ModerationValidationStepStatusType, string> = {
...
function ValidationStatusGraph({
  graph,
  isLoading,
  error,
}: {
...
function ModerationDetailDialog({
  ...
  validationGraph: ModerationValidationGraphType | undefined;
  isLoading: boolean;
