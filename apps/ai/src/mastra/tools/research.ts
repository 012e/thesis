...
/**
 * Fetches a public web page and returns normalized text, title, and
 * description so an agent can ground synthesis in real source content after a
 * web search. Shared by the search and deep-search agents.
 */
...
/**
 * Web research toolset shared by the search and deep-search agents: OpenAI web
 * search plus the source-grounding page fetcher.
 */
