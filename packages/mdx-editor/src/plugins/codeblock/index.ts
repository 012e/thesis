 ...
 * @group Code Block
 */
export const insertCodeBlock$ = Signal<Partial<CreateCodeBlockNodeOptions>>(
  (r) => {
    r.link(
      r.pipe(
        insertCodeBlock$,
 ...
 * @group Code Block
 */
export const appendCodeBlockEditorDescriptor$ = Appender(
  codeBlockEditorDescriptors$,
);
...
export const codeBlockPlugin = realmPlugin<{
  ...
  update(realm, params) {
    realm.pub(
      ...
      params?.defaultCodeBlockLanguage ?? "",
    );
  },
